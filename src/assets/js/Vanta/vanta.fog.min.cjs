!(function (e, t) {
    ...
    (() => {
        ...
        var e = {
                d: (t, i) => {
                    for (var o in i)
                        e.o(i, o) && !e.o(t, o) && Object.defineProperty(t, o, { enumerable: !0, get: i[o] });
                },
        ...
        n.VantaBase = class {
            ...
            windowMouseMoveWrapper(e) {
                ...
                i >= 0 &&
                    ...
                    i <= t.width &&
                    o <= t.height &&
                    ((this.mouseX = i), (this.mouseY = o), this.options.mouseEase || this.triggerMouseMove(i, o));
            }
        ...
        class l extends h {
            ...
            initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
                ...
                const i = new a.ShaderMaterial({ uniforms: this.uniforms, vertexShader: t, fragmentShader: e }),
